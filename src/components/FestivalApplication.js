...
export default class FestivalApplication extends React.Component {
    ...
    generateForm = () => {
        return(
            <Form onSubmit={(e) => this.handleSumbit(e)}>
                ...
                <Input name="cover_photo" placeholder="Cover Image" type="text" onChange={this.handleOnChange}/>
                <br></br>
                ...
                <Input name="trailer_id" placeholder="YouTube Trailer ID" type="text" onChange={this.handleOnChange}/>
                <br></br>
                <label>Full Video ID</label>
                <Input name="full_video_id" placeholder="YouTube Full Video ID" type="text" onChange={this.handleOnChange}/>
                <br></br>
    ...
    handleSumbit = (e) => {
        ...
        if(this.state.title && this.state.cover_photo && this.state.description && this.state.trailer_id && this.state.full_video_id){
            let {artist, festival, title, cover_photo, description, trailer_id, full_video_id} = this.state
            let piece = {
                artist_id: artist.id, 
                festival_id: festival.id, 
                title, cover_photo, description, trailer_id, full_video_id}
